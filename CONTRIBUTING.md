...
Fork the [project on Github](https://github.com/CoCreate-app/CoCreate-datatables.net) and check out your copy.

```
git clone https://github.com/contributor/CoCreate-datatables.net.git
cd CoCreate-datatables.net
git remote add upstream https://github.com/CoCreate-app/CoCreate-datatables.net.git
```
